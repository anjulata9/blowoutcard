...

{
    ...
    {
        $imageUploadId = $this->getRequest()->getParam('param_name', 'image_name');
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'homepage_banner/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'homepage_banner/' . $firstName . '/' . $secondName . '/';
            ...
            $imageResult['url'] = $mediaUrl . 'homepage_banner/' . $firstName . '/' . $secondName . '/' . $newImageName;
        } catch (\Exception $e) {
